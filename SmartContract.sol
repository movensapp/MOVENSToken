...
contract MOVENS is ERC20Detailed, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;

    event LogRebase(uint256 indexed epoch, uint256 totalSupply);

    string public constant _name = "MOVENS";
    string public constant _symbol = "MVNS";
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 1e9 * 10**DECIMALS;
    ...
    constructor() ERC20Detailed(_name, _symbol, uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityReceiver = 0xd1f3d4Da22B8863741e1ecE244c431980D56b945;
        treasuryReceiver = 0x388dab54ad18F5c228921d77E562c4A5BC815020;
        insuranceFundReceiver = 0x521364cF21d44cdc7A0820dD2Fa8a8Bc67153477;
